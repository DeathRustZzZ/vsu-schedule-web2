...
- `SCHEDULE_TZ_OFFSET` — смещение часового пояса для расписания (например, `+03:00`).
...
- `src/bot` — роутинг Telegram-событий и UX.
- `src/domain` — доменные модели и состояния регистрации.
- `src/db` — доступ к БД.
